...
public class RouteAdapter extends RecyclerView.Adapter<RouteAdapter.MyViewHolder> {
...

    {
        ...
        this.route_cxcount=route_cxcount;
    }
    ...
    public void onBindViewHolder(@NonNull RouteAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.cx_count_txt.setText(String.valueOf(route_cxcount.get(position)));
        ...
        holder.imgbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("cxcount",String.valueOf(route_cxcount.get(position)));
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView rid_txt,start_loc_txt,end_loc_txt,distance_txt,created_date_txt,modified_date_txt,is_default_txt,cx_count_txt;
        ...
        MyViewHolder(@NonNull View itemView) {
            ...
            cx_count_txt=itemView.findViewById(R.id.cxcount);
